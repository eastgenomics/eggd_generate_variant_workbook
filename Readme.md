...
```
  -icolour_cells VF:>=0.9:green                                   => single condition
  -icolour_cells VF:<0.8&>=0.6:orange                             => both of two conditions
  -icolour_cells VF:>0.9|<0.1:red                                 => either of two conditions
  -icolour_cells VF:>=0.9:green VF:<0.9&>=0.4:orange VF:>0.4:red  => multiple conditions to colour column across multiple ranges and colours
```
