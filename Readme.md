...
- If the CombinedVariantOutput.tsv file from Illuminas TSO500 local app is passed to `-iadditional_files`, only the TMB, MSI and Gene Amplifications sections will be written to the sheet. 
